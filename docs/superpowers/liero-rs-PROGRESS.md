...
>
> **Last updated:** 2026-06-28 · **Current focus:** Step 2, Slice 4b — Task 4 (C++ dumper `settings->shadow=false`)
...
│   ├─ 🔄 4b  terrain destruction — greenball / DrawDirtEffect   ◀── HERE (~50%)
│   │         (the level hash IS now a time series ✓)           T0–T3✅, T4 of 8 next
...
| Slice 4b (current) | **~50%** (T0–T3 done: datamodel, `draw_dirt_effect`, `blow_up` branch, integration — level hash now live; 4 tasks left) |
