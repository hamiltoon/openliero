...
>
> **Last updated:** 2026-06-29 · **Current focus:** Step 2, Slice 4d (Slice-3 deferrals), T1/9 done (dig carve live); T2 shell-drop next
...
│   └─ 🔄 4d  slice-3/4 deferrals (dig body, reload, shell, …)   ◀── HERE (T1/9 done — dig carve live)
