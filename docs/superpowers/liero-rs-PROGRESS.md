...
>
> **Last updated:** 2026-06-29 · **Current focus:** Step 2, Slice 4d (Slice-3 deferrals), T6/9 done (dumper [ammo] token); T7 scenario+golden next
...
│   └─ 🔄 4d  slice-3/4 deferrals (dig body, reload, shell, …)   ◀── HERE (T6/9 done — dumper [ammo] token)
