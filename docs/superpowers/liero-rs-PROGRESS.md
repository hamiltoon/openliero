...
>
> **Last updated:** 2026-06-28 · **Current focus:** Step 2, Slice 4b — Task 5 (greenball scenario + golden)
...
│   ├─ 🔄 4b  terrain destruction — greenball / DrawDirtEffect   ◀── HERE (~62%)
│   │         (the level hash IS now a time series ✓)           T0–T4✅, T5 of 8 next
...
| Slice 4b (current) | **~62%** (T0–T4 done: datamodel, `draw_dirt_effect`, `blow_up` branch, integration, dumper O4-omit; 3 tasks left) |
