...
>
> **Last updated:** 2026-06-28 · **Current focus:** Step 2, Slice 4c (explosion objects — sobjects+nobjects), T3 core port done, T4 next
...
│   ├─ 🔄 4c  explosion sobjects + nobjects — dart               ◀── HERE (T3/8 done — core port ✓)
...
| Slice 4c (current) | **~48%** (T0–T3 done + reviewed, core port ✓; T4 blow_up create_on_exp branch next) |
