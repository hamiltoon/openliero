...
>
> **Last updated:** 2026-06-28 · **Current focus:** Step 2, Slice 4c (explosion objects — sobjects+nobjects), T2 done, T3 (core port) next
...
│   ├─ 🔄 4c  explosion sobjects + nobjects — dart               ◀── HERE (T2/8 done — nobject_process)
...
| Slice 4c (current) | **~36%** (T0–T2 done + reviewed; T3 sobject_create/process — core port next) |
