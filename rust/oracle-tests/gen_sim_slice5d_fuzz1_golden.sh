#!/usr/bin/env bash
# Regenerates golden/sim_slice5d_fuzz1.txt by building a REAL C++ Game and driving 2 worms
...
"build/$PRESET/Release/oracle_dump_sim_physics" \
  "rust/oracle-tests/golden/sim_slice5d_fuzz1_scenario.txt" \
  "rust/oracle-tests/golden/sim_slice5d_fuzz1.txt"
echo "wrote rust/oracle-tests/golden/sim_slice5d_fuzz1.txt"
