#!/usr/bin/env bash
# Regenerates golden/sim_slice5d_fuzz2.txt by building a REAL C++ Game and driving 2 worms
...
# worm1, which starts at health 12 (< settings->health/4) so it DRIPS pre-death then DIES
...
"build/$PRESET/Release/oracle_dump_sim_physics" \
  "rust/oracle-tests/golden/sim_slice5d_fuzz2_scenario.txt" \
  "rust/oracle-tests/golden/sim_slice5d_fuzz2.txt"
echo "wrote rust/oracle-tests/golden/sim_slice5d_fuzz2.txt"
