#!/usr/bin/env bash
# Regenerates golden/sim_slice5prime_fuzz2.txt by building a REAL C++ Game and driving
...
# + common.materials. Variant 2 of 4 of the moving-worms fuzz: BOTH worms walk
...
"build/$PRESET/Release/oracle_dump_sim_physics" \
  "rust/oracle-tests/golden/sim_slice5prime_fuzz2_scenario.txt" \
  "rust/oracle-tests/golden/sim_slice5prime_fuzz2.txt"
echo "wrote rust/oracle-tests/golden/sim_slice5prime_fuzz2.txt"
