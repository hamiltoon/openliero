#!/usr/bin/env bash
# Regenerates golden/sim_slice5prime_fuzz3.txt by building a REAL C++ Game and driving
...
# + common.materials. Variant 3 of 4 of the moving-worms fuzz: BOTH worms walk
...
"build/$PRESET/Release/oracle_dump_sim_physics" \
  "rust/oracle-tests/golden/sim_slice5prime_fuzz3_scenario.txt" \
  "rust/oracle-tests/golden/sim_slice5prime_fuzz3.txt"
echo "wrote rust/oracle-tests/golden/sim_slice5prime_fuzz3.txt"
