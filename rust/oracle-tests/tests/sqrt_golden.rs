//! Differential test for `vector_length`/`isqrt` against the C++ oracle. See
//! `fixed_golden.rs` for the golden pattern. Each case's expected length comes
//! from `golden/sqrt.txt`, generated by C++ `VectorLength`.
